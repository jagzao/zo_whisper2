    ...
    def _build_initial_prompt(self) -> str:
        ...
        if self.language == "es":
            return (
                ...
                "Términos técnicos del proyecto: XR Technologies, designated person, UPSI, "
                "insider trading, compliance, trading window, PIT tool, NSDL, "
                "autorización services, InfoSec, GIS review, Risk Radar, UAT, "
                "JD, Sprint, APA, Hexaware, Piesd, AuthProdpath, CompliancePiesd, "
                "TrueLogic, FannyCheckmarx, jforgPublish, entrevista, volaris, "
                "configuringToAUT, JD bret Pa Amit, priyanka. "
                "Nombres propios: Vikas, Nuresh, Lydia, Arnaud. "
            ...
            return (
                ...
                "Project technical terms: XR Technologies, designated person, UPSI, "
                "insider trading, compliance, trading window, PIT tool, NSDL, "
                "authorization services, InfoSec, GIS review, Risk Radar, UAT, "
                "JD, Sprint, APA, Hexaware, Piesd, AuthProdpath, CompliancePiesd, "
                "TrueLogic, FannyCheckmarx, jforgPublish, interview, volaris, "
                "configuringToAUT, JD bret Pa Amit, priyanka. "
                "Proper names: Vikas, Nuresh, Lydia, Arnaud. "
