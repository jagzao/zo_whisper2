...
4. Routes results to project folders (`zo_`, `clienta_`, `jm_`, `interview/entrevista`).
...
|------------------|---------------|---------|
| `zo_` | `Videos/py_zo/` | - |
| `clienta_` | `Videos/py_clienta/` | `ClientAHandler` |
| `jm_` | `Videos/py_jm/` | - |
...
- **Auto-routing confirmation**: ask LLM whether a file should be routed to `clienta` vs `zo`.
