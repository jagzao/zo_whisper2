...
No conoce ClientA, Zo ni ningún proyecto en particular: `projects.json`
...
from transcript_pipeline.handlers.clienta_handler import ClientAHandler
...
HANDLER_MAP = {"clienta": ClientAHandler, "zo": ZoHandler, "meeting_dev": MeetingDevHandler}
